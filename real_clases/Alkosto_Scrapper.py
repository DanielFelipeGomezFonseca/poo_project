...
class AlkostoWebScrapper(WebScrapperDinamico):
    ...
    # Guarda todos los datos presentes en cada producto del atributo marca cada vez que lo encuentra
    ...
    # Guarda todos los datos presentes en cada producto del atributo marca una sola vez
